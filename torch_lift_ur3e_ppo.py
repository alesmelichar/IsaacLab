...
env = load_isaaclab_env(task_name="Isaac-Reach-UR10-v0")
env = wrap_env(env)
...
cfg["experiment"]["directory"] = "runs/torch/Isaac-Reach-UR3e-v0"
...
path = r"/home/urkui-3/Documents/Ales/IsaacLab/runs/torch/Isaac-Reach-UR3e-v0/UR3e/checkpoints/best_agent.pt"
agent.load(path)
