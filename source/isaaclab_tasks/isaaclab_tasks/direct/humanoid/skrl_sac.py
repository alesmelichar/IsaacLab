...
env = load_isaaclab_env(task_name="Isaac-Humanoid-Direct-v0", num_envs=256)
env = wrap_env(env)
...
# start training
# trainer.train()
agent.load(r"D:\IsaacLab\source\isaaclab_tasks\isaaclab_tasks\direct\humanoid\best_agent.pt")
trainer.eval()